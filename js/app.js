...
function ViewModel() {
    ...
    this.buildMarkerInfo = function(marker, yelpInfo) {
        // console.log("buildMarkerInfo called");
        // when marker clicked, bounce for 1 second
        ...
        if (yelpInfo.marker != marker) {
            ...
            yelpInfo.addListener('closeclick', function() {
                yelpInfo.marker = null;
            });
            $.ajax({
                method: "GET",
                headers: {
            ...
            //console.log("yelpInfo open map, marker")
        }
    };
    ...
    this.topLocationsShow = function() {
        //console.log("topLocationsShow called");
        self.buildMarkerInfo(this, self.markerInfoWindow);
    ...
    this.topLocations = ko.computed(function() {
        ...
        //console.log("topLocations called");
        var result = [];
